...
export default ({ close }) => (
  <div className="menu">
    <ul>
      ...
      <li onClick={close}><Link exact to="/les-jfac-20">JFAC</Link></li>
      <li onClick={close}><Link exact to="/nous-contacter">Nous contacter</Link></li>
      <li onClick={close}><Link exact to="/la-galerie-des-jfac">Galerie</Link></li>
      <li onClick={close}><Link exact to="/videotheque">Vidéotèque</Link></li>
