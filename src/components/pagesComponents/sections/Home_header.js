        ...
        <div className="tiny:hidden xs:hidden sm:hidden md:hidden mdi:block h-auto max-w-xl text-black ml-8">
          <h1
            dangerouslySetInnerHTML={{
              __html: data.ApisRefacc.postBy.En_Tete_avec_slide.titreEnTete,
            }}
            className="xl:text-4xl lg:text-4xl md:text-2xl mdi:text-2xl font-bold text-black"
          ></h1>
          <p dangerouslySetInnerHTML={
                {__html:data.ApisRefacc.postBy.En_Tete_avec_slide.contenuDeLenTete}
              } className="xl:text-xl lg:text-xl md:text-lg w-auto text-black xl:font-bold ">
